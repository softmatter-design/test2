...
\begin{frame}
    ...
    \note[item]{で、私のお話はといいますと、大した実績もあるわけではありませんので、自身の経験を振り返りながら、素人が物事をきちんと理解するためにはどうすればいいんだろうというような立場でお話したいと思います。}
...
\begin{frame}
    ...
    \note[item]{海外留学時に再発見したオキセタンの反応性検討を機会にミクロなMOシミュレーションの道へ}
...
\begin{frame}
    ...
    \note[item]{各スケールで異なる物理があるというマルチフィジックスは、人間の勝手な都合で、}
...
\begin{frame}
    ...
    \begin{columns}[T, onlytextwidth]
        ...
        \column{.47\linewidth}
        \note[item]{化学系出身の私には、隣に芝生は青いと見えているのかもしれませんが、物理的な考え方は、理論の筋道をきちんと捉えようとしていると感じます。}
...
\begin{frame}
    ...
    \note[item]{ソフトマターでは、結構自由な考え方があります。これをほんのタイトルにしたのは御茶ノ水の奥村先生ですが。}
    \begin{itemize}
